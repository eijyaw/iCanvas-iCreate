...
public enum PainterTouch_BrushMode { PAINT, DECAL };
public class TXTPaintTouchTest : MonoBehaviour
{
    ...
    GraphicRaycaster testGRay;
    PointerEventData pointerE;
    EventSystem ETest;
    ...
    PainterTouch_BrushMode mode; //Our painter mode (Paint brushes or decals)
    ...
    private void Awake()
    {
        ...
        testGRay = GetComponent<GraphicRaycaster>();
        ETest = GetComponent<EventSystem>();
    ...
    void DoAction()
    {
        ...
        if (HitTestUVPosition(ref uvWorldPosition))
        {
            ...
            if (mode == PainterTouch_BrushMode.PAINT)
            {
    ...
    public void SetBrushMode(PainterTouch_BrushMode brushMode)
    { //Sets if we are painting or placing decals
        mode = brushMode;
        brushCursor.GetComponent<SpriteRenderer>().sprite = brushMode == PainterTouch_BrushMode.PAINT ? cursorPaint : cursorDecal;
    }
